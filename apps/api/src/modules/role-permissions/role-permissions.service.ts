...
const VALID_MODULES = [
  ...
  'inventory-consult',
  'purchases', 'pedidos', 'cash', 'receivables', 'payables', 'fiscal',
  'users', 'settings', 'expenses', 'payment-schedules', 'store', 'payroll', 'incidents', 'divisas', 'bancos', 'almacen', 'exhibicion', 'mi-perfil',
