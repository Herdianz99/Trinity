...
CREATE TABLE IF NOT EXISTS "Warehouse" (
    ...
    "isActive" BOOLEAN NOT NULL DEFAULT true,
    "countsForSale" BOOLEAN NOT NULL DEFAULT true,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreditDebitNote
DO $$ BEGIN CREATE TYPE "SalesReturnReason" AS ENUM ('ASESORIA', 'CLIENTE', 'FALTANTE_ALMACEN', 'PRODUCTO_DEFECTUOSO'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
-- Libro mayor de caja (tabla madre del arqueo) + flag de interruptor.
...
CREATE TABLE IF NOT EXISTS "CashLedgerEntry" (
  "id" TEXT NOT NULL, "cashSessionId" TEXT NOT NULL, "direction" "CashDir" NOT NULL,
  "amountUsd" DOUBLE PRECISION NOT NULL DEFAULT 0, "amountBs" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "currency" TEXT NOT NULL, "exchangeRate" DOUBLE PRECISION NOT NULL DEFAULT 0, "methodId" TEXT,
  "isCash" BOOLEAN NOT NULL DEFAULT true, "sourceType" TEXT NOT NULL, "sourceId" TEXT, "reason" TEXT,
...
-- =============================================================================
-- Modulo de ALMACEN (Auditoria 5S + Reporte de daños). Ses. 2026-08-22.
-- Aislado, permiso 'almacen', opt-in useAlmacenOps. Aditivo e idempotente.
-- =============================================================================
...
-- Divisas: Bs (cargas por empresa + Bs por movimiento) y maestro de banco de origen
...
CREATE TABLE IF NOT EXISTS "TreasuryBsLoad" (
  "id" TEXT NOT NULL, "date" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, "companyId" TEXT NOT NULL,
  "amountBs" DOUBLE PRECISION NOT NULL, "note" TEXT, "createdById" TEXT NOT NULL,
  "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- Red de seguridad idempotente (por si la migracion no corrio). Ver
-- migrations/20260826160000_disciplinary_module.
-- =============================================================================
...
-- Recepcion de mercancia (modulo Almacen, Session 128): ficha documental, NO mueve stock
