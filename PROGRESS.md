...
## 🗓️ Sesión 2026-08-17 — Análisis de plataformas (Cashea/Crediagro) + filtro de vendedor oculto al SELLER + pendiente en Bs en el POS

> ### ⏳ EN GIT, PENDIENTE DE DEPLOY — HEAD `18439ff` (sobre `6783a7d`)
> Tres features: dos **solo de frontend** + uno **backend+frontend de solo lectura** (sin migración). Probados en local (typecheck API+Web limpio, página y endpoint responden 200, números validados contra `grande_db`). **Falta desplegar a las 6 empresas.**
