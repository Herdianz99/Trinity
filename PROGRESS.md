...
> **✅ Desplegado en la GRANDE (`inversiones`) el 2026-07-23** (HEAD `fdacd25`, PM2 online, health 200). **CHICA (`eltrebol`, 134.209.220.233): deploy planificado para hoy 2026-07-23 "en un rato".** Comando: `ssh root@134.209.220.233 "cd /opt/Trinity && git pull origin main && bash deploy.sh"` (trae la migración `20260723150000_payroll_line_bonus` + `nodemailer`). Verificado en local: `tsc --noEmit` OK en API y web.
