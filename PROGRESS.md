...
## 🗓️ Sesión 128 (2026-09-17) — Dashboard: KPI Ventas con brecha vs sin brecha + dropdown de reportes en Sesión de códigos de barras

> ### ⚠️ SIN DESPLEGAR (todo en `main`) — arranca INOFENSIVO. Solo lectura/UI, sin migraciones ni cambios de schema. Deploy estándar (`git pull && bash deploy.sh`).
