...
- **Pendiente:** e2e final en navegador por Diego + deploy a la grande (aplica **2 migraciones**: `20260901120000_treasury_bs_movement` y `20260901160000_treasury_movement_rate_commission`).
