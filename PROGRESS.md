...
> ### ⏳ SIN DESPLEGAR aún — HEAD `e65aefc`. Todo probado en local con **copia fresca de la BD de la grande** (dump plano pg16→pg15 sobre `grande_db`). Una migración aditiva pendiente (`20260830170000_partner_transfer_accounts_config`).
