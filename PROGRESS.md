...
> **✅ Desplegado en la GRANDE (`inversiones`) el 2026-07-23** (HEAD `fdacd25`, PM2 online, health 200). **PENDIENTE en la CHICA (`eltrebol`).** Verificado en local: `tsc --noEmit` OK en API y web.
